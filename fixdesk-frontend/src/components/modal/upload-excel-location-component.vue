/**
 * =====================================================================
 * @file            upload-excel-location-component.vue
 * @module
 ...
 * ---------------------------------------------------------------------
 * @description
 *  คอมโพเนนต์อัปโหลดและแปลงไฟล์ Excel (.xlsx) สำหรับข้อมูลตำแหน่ง
 *  อ่าน sheet แรก แปลงเป็นอ็อบเจ็กต์สถานที่และตรวจสอบฟิลด์ที่จำเป็น
 *  แล้วส่งข้อมูลที่แปลงผ่าน `next`
 *
 * @requires
 *  - vue
 *  - xlsx
