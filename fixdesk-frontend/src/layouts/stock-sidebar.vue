 ...
 * ---------------------------------------------------------------------
 * @description
 *  Sidebar Component สำหรับผู้ใช้งาน (Stock Role)
 *
 *  ทำหน้าที่:
 ...
 *     [2026-02-05, พชร ไพศรีสกุล] V 1.4.1
 *   - fix(stock-sidebar): แก้ไข feedback จาก TestCase
 *     [2026-02-10, พชร ไพศรีสกุล] V 1.4.2
 *   - Refactor Sidebar เป็น Section-based และปรับปรุง UX
 *     [2026-02-22, พชร ไพศรีสกุล] V 1.5.0
 *
 * =====================================================================
 */
...
const menuSections = [
  ...
  {
    title: 'การจัดการคลัง',
    items: [{ icon: StockIcon, label: 'จัดการคลังสินค้า', path: '/main/stock-manage-inventory' }],
  },
]
</script>
