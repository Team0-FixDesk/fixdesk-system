...
const menus = [
  { icon: '/icon/sidebar/home-icon.svg', label: 'หน้าหลัก', path: '/stock-home' },
  ...
  { icon: '/icon/sidebar/logs-list-icon.svg', label: 'รายการเบิกของ', path: '/stock-withdraw-list' },
  { icon: '/icon/sidebar/history-list-icon.svg', label: 'ประวัติการเบิกของ', path: '/stock-withdraw-history' },
  { icon: '/icon/sidebar/stock-icon.svg', label: 'จัดการคลัง', path: '/stock-manage-inventory' },
]
</script>
