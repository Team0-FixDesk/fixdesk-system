...
/**
 * =====================================================================
 * @file            technician-lead-sidebar.view.vue
 ...
 * ---------------------------------------------------------------------
 * @description
 *  Sidebar Component สำหรับหัวหน้าช่าง (Technician Lead Role)
 *
 *  ทำหน้าที่:
 ...
 *   - สร้างไฟล์ใหม่สำหรับ Technician Lead
 *
 * =====================================================================
 */
...
const menuSections = [
  ...
  },
  {
    ...
    items: [
      { icon: StockIcon, label: 'จัดการคลังสินค้า', path: '/main/stock-manage-inventory' },
