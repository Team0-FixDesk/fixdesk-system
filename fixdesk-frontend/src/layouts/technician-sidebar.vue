...
const menus = [
  ...
  { icon: '/icon/sidebar/logs-list-icon.svg', label: 'รายการงานแจ้งซ่อม', path: '/main/technician-repair-list' },
  { icon: '/icon/sidebar/history-list-icon.svg', label: 'ประวัติของฉัน', path: '/main/technician-history' },
  { icon: '/icon/sidebar/dashboard-icon.svg', label: 'รายการในคลัง', path: '/main/technician-stock-list' },
  { icon: '/icon/sidebar/stock-icon.svg', label: 'รายการเบิกของฉัน', path: '/main/technician-my-stock' },
]
