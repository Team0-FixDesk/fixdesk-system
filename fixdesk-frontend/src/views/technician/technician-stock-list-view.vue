 ...
 *   - เพิ่ม Dropdown เลือกหมายเลขแจ้งซ่อม ก่อนเบิกของ
 *      [2026-06-29, พิมลพรรณ มามาก] V1.0.4
 * =====================================================================
 */
        ...
        <div class="flex-1 overflow-y-auto px-5 py-4">
          <div v-if="cartStep === 'list'">
                <label class="block text-sm font-medium text-gray-700 mb-1">
                  หมายเลขใบแจ้งซ่อม <span class="text-red-500">*</span>
                </label>
                <select
                ...
                >
                  <option :value="null" disabled>-- เลือกรายการแจ้งซ่อม --</option>
                  <option v-for="job in repairJobList" :key="job.rf_code" :value="job.rf_code">
                    {{ job.rf_code }} - {{ job.rf_title }}
                  </option>
                </select>
